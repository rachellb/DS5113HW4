...
restarts = 10   # The number of times the program will restart
...
x_top = x_curr          # List to store best solutions
f_top = evaluate(x_curr)          
...
while restarts != 0:
    ...
    if f_curr > f_top:
        ...
        print ("Best value found so far: ", f_top)   
    
    restarts = restarts - 1
    
print ("\nFinal number of solutions checked: ", solutionsChecked)
print ("Best value found: ", f_top[0])
print ("Weight is: ", f_top[1])
print ("Total number of items selected: ", np.sum(x_top))
print ("Best solution: ", x_top)
